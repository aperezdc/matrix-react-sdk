            ...
            <div className={toolbarClasses}>
                ...
                <div className="mx_MatrixToolbar_content">
                    { this.props.policyUrl ? _t(
                        "Allow sent stats to stats.igalia.com by sending <UsageDataLink>anonymous usage data</UsageDataLink>. " +
                        ...
                        "Allow to sent stats to stats.igalia.com by sending <UsageDataLink>anonymous usage data</UsageDataLink>. " +
                        "This will use a cookie.",
                        {},
                        {
                            'UsageDataLink': (sub) => <a
